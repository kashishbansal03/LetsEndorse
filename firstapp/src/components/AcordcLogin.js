...
import './AcordcLogin.css'
import { Link } from "react-router-dom";
function AcordcLogin() {
    ...
    const {
      ...
      const clicksubmit=(data)=>{
        ...
        console.log("login credentials of acordc",data)
      }
  return (
    ...
    >
      ...
      <div className="h-[50%] flex flex-col justify-start text-center m-[30px]">
        <h3 className="mb-[30px] heading text-[#5655c6]">LOGIN AS AC/DC</h3>
